...
document.querySelector('#submit').addEventListener('click', () => {
    ...
    const todo_inputs_el = document.createElement('input');
    todo_inputs_el.classList.add('text');
    todo_inputs_el.value = inputData;
    todo_inputs_el.type = 'text';
    todo_inputs_el.setAttribute('readonly', 'readonly');

    todo_content_el.appendChild(todo_inputs_el);
    ...
    todo_done_el.addEventListener('click', () => {
        todo_inputs_el.classList.add('done');
    ...
    todo_edit_el.addEventListener('click', (e) => {
        if(todo_edit_el.classList.contains('edit')){
            ...
            todo_inputs_el.removeAttribute("readonly");
            todo_inputs_el.focus();
        } else {
